...
const createStyles = (COLORS) => StyleSheet.create({
  ...
  productImage: { width: '100%', height: 120, backgroundColor: '#FAFAFA' },
  productImagePlaceholder: { height: 120, justifyContent: 'center', alignItems: 'center', backgroundColor: '#FAFAFA' },
